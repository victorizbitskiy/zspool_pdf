...
It is often necessary to get a PDF in xstring or binary format. To do this, you can send a report from your z-report to the sap-spool (in the background), and then read PDF by the spool ID.  
